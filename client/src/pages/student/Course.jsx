    ...
    <Card className="overflow-hidden rounded-lg dark:bg-gray-800 bg-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
      {/* image */}
        ...
        <CardContent className='px-5 py-4 space-y-3'>
            <h1 className='hover:underline font-bold text-lg  truncate text-center'>{course.courseTitle}</h1>

            {/* add an instructor avatar and name */}
            ...
            <div className='flex items-center justify-between'>
              ...
              <Badge className={'bg-blue-600 text-white px-2 py-1 mt-1 text-xs rounded-full'}>
                {course.courseLevel}
              </Badge>
            </div>
